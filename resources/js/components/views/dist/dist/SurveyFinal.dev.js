...
var SurveyFinal = function SurveyFinal(props) {
  var classes = props.classes;
  return react_1["default"].createElement(core_1.Grid, {
    container: true,
    "justify-xs-space-between": true,
  ...
  }, "Gracias! Hemos recibido tus comentarios")), react_1["default"].createElement(core_1.Grid, {
    item: true,
    className: classes.dscrGroup
  }, react_1["default"].createElement("h3", {
    className: classes.dscrText
  }, "Mira tu opini\xF3n y la de otros usuarios en nuestra app. Califica, Comenta y Gana cupones de descuento por tus comentarios.")), react_1["default"].createElement(core_1.Grid, {
    item: true
  }, react_1["default"].createElement(core_1.Grid, {
    container: true,
    direction: "column",
  ...
  }, "Desc\xE1rgala ahora!")), react_1["default"].createElement(core_1.Grid, {
    item: true,
    className: classes.logGroup
  }, react_1["default"].createElement(core_1.Grid, {
    container: true,
    ...
    src: log_png_1["default"],
    alt: "Can not load image!"
  }))), react_1["default"].createElement(core_1.Grid, {
    item: true,
    className: classes.logGroup
  }, react_1["default"].createElement("p", {
    className: classes.qubuText
  }, "QUBU", react_1["default"].createElement(Copyright_1["default"], {
    style: {
      fontSize: 10
    }
  }))), react_1["default"].createElement(core_1.Grid, {
    ...
    src: appstore1_png_1["default"],
    alt: "Can not load image!"
  }), react_1["default"].createElement("img", {
    src: googlestore1_png_1["default"],
    alt: "Can not load image!"
  }))))))), react_1["default"].createElement(core_1.Grid, {
    sm: 1,
    md: 1,
