...
function RecipeReviewCard() {
  ...
  var _b = react_1["default"].useState(2),
      value = _b[0],
      setValue = _b[1];
  ...
  var SelectType = function SelectType(nType) {
    console.log(nType);
  };
  ...
  return react_1["default"].createElement(Grid_1["default"], {
    ...
    subheader: "Escoge la opci\xF3n que m\xE1s se ajuste al comentario que har\xE1s sobre esta empresa."
  }), react_1["default"].createElement(CardContent_1["default"], null, react_1["default"].createElement(Typography_1["default"], {
    variant: "subtitle1",
    color: "textSecondary",
    component: "p"
  }, "Quiero opinar esta empresa como:"), react_1["default"].createElement(Grid_1["default"], {
    container: true,
    direction: "column",
  ...
  }, "CLIENTE"), react_1["default"].createElement(Button_1["default"], {
    variant: "contained",
    href: "/survey/detail",
    onClick: function onClick() {
      return SelectType(1);
    },
    className: classes.btnEmployee
  }, "EMPLEADO"), react_1["default"].createElement(Button_1["default"], {
    variant: "contained",
    href: "/survey/detail",
    onClick: function onClick() {
      return SelectType(2);
