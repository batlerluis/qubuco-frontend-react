...
function RecipeReviewCard() {
  ...
  var SelectRating = function SelectRating(nValue) {
    setRatingValue(nValue);
    setStep(2);
  };

  var SelectExp = function SelectExp(nValue) {
    setStep(3);
  };

  var SelectFinal = function SelectFinal(nValue) {
    setStep(4);
  };
  ...
  if (step == 1) {
    cardBody = react_1["default"].createElement("div", null, react_1["default"].createElement(CardHeader_1["default"], {
      avatar: react_1["default"].createElement("img", {
        src: car_png_1["default"],
        className: classes.avatar
      }),
      action: react_1["default"].createElement(Card_1["default"], {
      ...
      }, react_1["default"].createElement(SettingsBackupRestore_1["default"], null), "Regresar")),
      ...
      color: "textSecondary",
      component: "p"
    }, "Question 1"), react_1["default"].createElement(LinearProgress_1["default"], {
      variant: "buffer",
      value: 33,
    ...
    }, "C\xF3mo te sientes con las pol\xEDticas de calidad de la empresa?"), react_1["default"].createElement(Rating_1["default"], {
    ...
    }, "Omitir", react_1["default"].createElement(ArrowForward_1["default"], null)))));
  } else if (step == 2) {
    cardBody = react_1["default"].createElement("div", null, react_1["default"].createElement(CardHeader_1["default"], {
      avatar: react_1["default"].createElement("img", {
        src: car_png_1["default"],
      ...
      color: "textSecondary",
      component: "p"
    }, "Question 2"), react_1["default"].createElement(LinearProgress_1["default"], {
      variant: "buffer",
      value: 67,
      className: classes.progBar
    }), react_1["default"].createElement(Box_1["default"], {
      ...
      component: "p",
      className: classes.description
    }, "Te gusto el servicio en tu \xFAltima experiencia con nuestra empresa?"), react_1["default"].createElement(Grid_1["default"], {
      container: true,
      direction: "column",
    ...
    }, "OPCI\xD3N POSITIVA"), react_1["default"].createElement(Button_1["default"], {
      variant: "contained",
      color: "inherit",
      onClick: function onClick() {
        return SelectExp(1);
    ...
    }, "OPCI\xD3N NEGATIVA"))), react_1["default"].createElement(Card_1["default"], {
      className: classes.skip
    }, react_1["default"].createElement(IconButton_1["default"], {
      "aria-label": "skip",
      onClick: function onClick() {
    ...
    cardBody = react_1["default"].createElement("div", null, react_1["default"].createElement(CardHeader_1["default"], {
      ...
      color: "textSecondary",
      component: "p"
    }, "Question 3"), react_1["default"].createElement(LinearProgress_1["default"], {
      variant: "buffer",
      value: 100,
      className: classes.progBar
    }), react_1["default"].createElement(Box_1["default"], {
      ...
      color: "primary",
      onClick: function onClick() {
        return SelectFinal(0);
      },
      className: classes.btnClient
    }, "OPCI\xD3N A"), react_1["default"].createElement(Button_1["default"], {
      variant: "contained",
      color: "primary",
      onClick: function onClick() {
        return SelectFinal(1);
      },
      className: classes.btnClient
    }, "OPCI\xD3N B"), react_1["default"].createElement(Button_1["default"], {
      variant: "contained",
      color: "primary",
      onClick: function onClick() {
        return SelectFinal(2);
      },
      className: classes.btnClient
    }, "OPCI\xD3N C"))), react_1["default"].createElement(Card_1["default"], {
      className: classes.skip
    }, react_1["default"].createElement(IconButton_1["default"], {
      "aria-label": "skip",
      onClick: function onClick() {
    ...
    cardBody = react_1["default"].createElement("div", null, react_1["default"].createElement(CardHeader_1["default"], {
      ...
      color: "textSecondary",
      component: "p"
    }, "Comparte tus experiencias con otros usuarios, y ayuda a nuestra comunidad a encontrar empresas de calidad."), react_1["default"].createElement(TextareaAutosize_1["default"], {
      rows: 5,
  ...
  return react_1["default"].createElement(styles_1.ThemeProvider, {
    ...
    href: "/home",
    "aria-label": "menu"
  }, react_1["default"].createElement(ArrowBackIos_1["default"], null), "SALIR"))), react_1["default"].createElement(Card_1["default"], {
